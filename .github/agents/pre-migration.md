...
- IF some imports could not be moved due to no confirmed new home, report it and mark step 2 as incomplete.
...
- If the build fails, analyze the errors and fix them ONLY IF it would not contradict the migration guide before reporting.
